...
export const MapRoutes = () => {
    ...
    const [data, setData] = useState([res1?.UserOne, res2?.result, res3?.UserTwo]);
    ...
    const changeRoute = (index) => {
        ...
        window.location.href = `Analytics?lats=${lats}&lngs=${lngs}&late=${late}&lnge=${lnge}`;
    }
    ...
    return (
        <div className="App">
            ...
            <div style={{ height: "400px", width: "100%" }}>
                <GoogleMapReact
                    bootstrapURLKeys={{
                        key: "AIzaSyAsbwt4GElIq_C9duQZxcb2tiX3luBGuRo"
                    }}
